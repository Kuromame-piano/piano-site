...
export const areas: Area[] = [
    ...
    // ========================================
    {
        ...
        uniqueContent: "豊洲でピアノ教室を検討する方には、江東区公開統計（2026年2月）で豊洲の人口は40,274人、0〜14歳比率は17.9％という地域データがあります。豊洲駅〜ららぽーと豊洲周辺はタワーマンション居住世帯が多く、送迎時間圧縮ニーズが高いため、通室型では送迎や移動の負担が継続の壁になりやすい傾向があります。出張ピアノレッスンなら講師がご自宅に伺うため、移動時間を使わずにレッスンを開始できます。送迎を減らしながら学習時間と習い事を両立したいご家庭を中心に、塾と学校課題の合間に短時間で質の高いレッスンを求めるご家庭にも対応し、電子ピアノ環境でも基礎・読譜・表現を段階的に伸ばします。",
        instructorIntroduction: "お子様の教育に熱心なご家庭が多い豊洲エリア。移動時間ゼロの出張レッスンで、習い事の送迎にかかる負担をなくし、ご家庭での団らんや学習の時間もしっかり確保できます。基礎技術の習得はもちろん、一人ひとりの感性を尊重する指導を大切にしています。いつものリラックスできる環境だからこそ、お子様の集中力も自然と高まります。",
            ...
            primary: {
                label: "タワマン子育て世帯",
                summary: "送迎を減らしながら学習時間と習い事を両立したいご家庭。",
                painPoints: [
            ...
            secondary: {
                label: "中学受験と両立家庭",
                summary: "塾と学校課題の合間に短時間で質の高いレッスンを求めるご家庭。",
                painPoints: [
                    "塾や宿題で平日の可処分時間が短い",
                    "移動を増やすと学習リズムが崩れやすい",
                    "短時間でも成果が見える練習設計が必要"
        ...
        needSolutions: [
            {
                need: "豊洲で送迎と家事・仕事が重なり、習い事の継続負担が大きい。",
        ...
        areaGuide: "豊洲でレッスンを続ける鍵は、送迎ゼロで学習時間を削らない運用運用を行うことです。有楽町線・ゆりかもめ利用者が多く、平日夕方に移動を増やさない習い事設計が有効という生活条件を前提に、学校・塾・仕事・家事と衝突しにくい曜日と時間帯を体験時に設計します。開始後は毎回の練習ポイントを短く共有し、次回までに何を行うかを明確にするため、忙しい週でも上達実感を得やすくなります。",
    ...
    },
    {
        ...
        uniqueContent: "有明でピアノ教室を検討する方には、江東区公開統計（2026年2月）で有明の人口は13,942人、0〜14歳比率は21.1％という地域データがあります。有明ガーデン周辺は新規入居の子育て世帯が多く、習い事の立ち上げ相談が集中しやすいため、通室型では送迎や移動の負担が継続の壁になりやすい傾向があります。出張ピアノレッスンなら講師がご自宅に伺うため、移動時間を使わずにレッスンを開始できます。初めての習い事を移動負担なく始めたい子育て世帯を中心に、兄弟で効率よくレッスン時間をまとめたいご家庭にも対応し、電子ピアノ環境でも基礎・読譜・表現を段階的に伸ばします。",
        ...
        areaGuide: "有明でレッスンを続ける鍵は、新生活の導線に無理なく組み込む時間設計運用を行うことです。広域移動が発生しやすい街区構造のため、通室不要のレッスンが時間効率を高めるという生活条件を前提に、学校・塾・仕事・家事と衝突しにくい曜日と時間帯を体験時に設計します。開始後は毎回の練習ポイントを短く共有し、次回までに何を行うかを明確にするため、忙しい週でも上達実感を得やすくなります。",
        lessonFlow: defaultLessonFlow,
    ...
    },
    {
        ...
        uniqueContent: "東雲でピアノ教室を検討する方には、江東区公開統計（2026年2月）で東雲の人口は25,508人、0〜14歳比率は17.0％という地域データがあります。東雲キャナルコート周辺は集合住宅比率が高く、電子ピアノ運用の相談が多いため、通室型では送迎や移動の負担が継続の壁になりやすい傾向があります。出張ピアノレッスンなら講師がご自宅に伺うため、移動時間を使わずにレッスンを開始できます。帰宅後の限られた時間でレッスンを継続したいご家庭を中心に、塾・学校・習い事を同時に回すため移動を最小化したいご家庭にも対応し、電子ピアノ環境でも基礎・読譜・表現を段階的に伸ばします。",
        ...
        areaGuide: "東雲でレッスンを続ける鍵は、帰宅後30分以内に開始できる運用運用を行うことです。りんかい線・有楽町線接続を使う共働き世帯が多く、帰宅後すぐ始められる形式が支持されるという生活条件を前提に、学校・塾・仕事・家事と衝突しにくい曜日と時間帯を体験時に設計します。開始後は毎回の練習ポイントを短く共有し、次回までに何を行うかを明確にするため、忙しい週でも上達実感を得やすくなります。",
        lessonFlow: defaultLessonFlow,
    ...
    // ========================================
    {
        ...
        uniqueContent: "月島でピアノ教室を検討する方には、中央区の町丁別集計（2023年1月）で月島の人口は16,834人という地域データがあります。月島駅・佃エリアは高層住宅が集中し、エレベーター移動のみで完結する習い事需要が高いため、通室型では送迎や移動の負担が継続の壁になりやすい傾向があります。出張ピアノレッスンなら講師がご自宅に伺うため、移動時間を使わずにレッスンを開始できます。兄弟それぞれの習い事を移動負担なく回したいご家庭を中心に、家事や仕事の合間にピアノを再開したい大人の方にも対応し、電子ピアノ環境でも基礎・読譜・表現を段階的に伸ばします。",
        ...
        areaGuide: "月島でレッスンを続ける鍵は、家族全体の予定を崩さない連続受講設計運用を行うことです。共働き家庭の比率が高く、兄弟連続受講で時間を一本化する相談が増えているという生活条件を前提に、学校・塾・仕事・家事と衝突しにくい曜日と時間帯を体験時に設計します。開始後は毎回の練習ポイントを短く共有し、次回までに何を行うかを明確にするため、忙しい週でも上達実感を得やすくなります。",
        lessonFlow: defaultLessonFlow,
    ...
    },
    {
        ...
        uniqueContent: "勝どきでピアノ教室を検討する方には、中央区の町丁別集計（2023年1月）で勝どきの人口は27,108人という地域データがあります。勝どき駅周辺は高層住宅が連続し、通室よりも訪問型の時間効率が評価されやすいため、通室型では送迎や移動の負担が継続の壁になりやすい傾向があります。出張ピアノレッスンなら講師がご自宅に伺うため、移動時間を使わずにレッスンを開始できます。移動コストを減らし平日夜に習い事を定着させたいご家庭を中心に、保育園・学童後の時間帯に固定枠を持ちたいご家庭にも対応し、電子ピアノ環境でも基礎・読譜・表現を段階的に伸ばします。",
        ...
        areaGuide: "勝どきでレッスンを続ける鍵は、保育園後から夕食前までの隙間時間活用運用を行うことです。平日夕方〜夜の生活密度が高く、移動を伴わない習い事の相性が良いという生活条件を前提に、学校・塾・仕事・家事と衝突しにくい曜日と時間帯を体験時に設計します。開始後は毎回の練習ポイントを短く共有し、次回までに何を行うかを明確にするため、忙しい週でも上達実感を得やすくなります。",
        lessonFlow: defaultLessonFlow,
    ...
    },
    {
        ...
        uniqueContent: "晴海でピアノ教室を検討する方には、中央区の町丁別集計（2023年1月）で晴海の人口は18,660人という地域データがあります。晴海フラッグ周辺は新築マンション比率が高く、初回相談で電子ピアノ環境確認が重要ため、通室型では送迎や移動の負担が継続の壁になりやすい傾向があります。出張ピアノレッスンなら講師がご自宅に伺うため、移動時間を使わずにレッスンを開始できます。新生活に合わせて無理なく習い事を立ち上げたいご家庭を中心に、楽器経験ゼロから安全に始めたい未就学〜低学年家庭にも対応し、電子ピアノ環境でも基礎・読譜・表現を段階的に伸ばします。",
        ...
        areaGuide: "晴海でレッスンを続ける鍵は、転入直後でも無理のない立ち上げ運用を行うことです。通学・通勤導線が長くなりやすく、送迎不要のレッスンが家事負荷を軽減するという生活条件を前提に、学校・塾・仕事・家事と衝突しにくい曜日と時間帯を体験時に設計します。開始後は毎回の練習ポイントを短く共有し、次回までに何を行うかを明確にするため、忙しい週でも上達実感を得やすくなります。",
        lessonFlow: defaultLessonFlow,
    ...
    // ========================================
    {
        ...
        uniqueContent: "清澄白河でピアノ教室を検討する方には、江東区公開統計（2026年2月）で清澄・白河合算人口は15,417人、65歳以上比率は19.4％という地域データがあります。清澄白河駅周辺は文化施設と住宅が近接し、子どもと大人の併用受講ニーズがあるため、通室型では送迎や移動の負担が継続の壁になりやすい傾向があります。出張ピアノレッスンなら講師がご自宅に伺うため、移動時間を使わずにレッスンを開始できます。基礎に加えて音楽表現を丁寧に育てたい親子を中心に、仕事や家事の合間に再開し長く続けたい大人の方にも対応し、電子ピアノ環境でも基礎・読譜・表現を段階的に伸ばします。",
        ...
        areaGuide: "清澄白河でレッスンを続ける鍵は、基礎と表現の両立を日常練習に落とし込む運用運用を行うことです。落ち着いた住宅街で自宅練習がしやすく、表現指導との相性が高いという生活条件を前提に、学校・塾・仕事・家事と衝突しにくい曜日と時間帯を体験時に設計します。開始後は毎回の練習ポイントを短く共有し、次回までに何を行うかを明確にするため、忙しい週でも上達実感を得やすくなります。",
        lessonFlow: defaultLessonFlow,
    ...
    },
    {
        ...
        uniqueContent: "平野でピアノ教室を検討する方には、江東区公開統計（2026年2月）で平野の人口は7,584人、0〜14歳比率は14.1％という地域データがあります。清澄白河駅徒歩圏の住宅街で、通室より自宅完結型の習い事が生活導線に合いやすいため、通室型では送迎や移動の負担が継続の壁になりやすい傾向があります。出張ピアノレッスンなら講師がご自宅に伺うため、移動時間を使わずにレッスンを開始できます。落ち着いた自宅環境で集中して学ばせたいご家庭を中心に、通室せずマイペースに再開したい大人の方にも対応し、電子ピアノ環境でも基礎・読譜・表現を段階的に伸ばします。",
        ...
        areaGuide: "平野でレッスンを続ける鍵は、静かな自宅環境を活かした集中設計運用を行うことです。戸建・低層住宅も多く、練習時間の設計相談がしやすいという生活条件を前提に、学校・塾・仕事・家事と衝突しにくい曜日と時間帯を体験時に設計します。開始後は毎回の練習ポイントを短く共有し、次回までに何を行うかを明確にするため、忙しい週でも上達実感を得やすくなります。",
        lessonFlow: defaultLessonFlow,
    ...
    },
    {
        ...
        uniqueContent: "三好でピアノ教室を検討する方には、江東区公開統計（2026年2月）で三好の人口は5,420人、65歳以上比率は21.0％という地域データがあります。清澄白河駅近接の住宅地で、子どもと大人の併用ニーズが継続的にあるため、通室型では送迎や移動の負担が継続の壁になりやすい傾向があります。出張ピアノレッスンなら講師がご自宅に伺うため、移動時間を使わずにレッスンを開始できます。生活の質を上げる趣味としてピアノを続けたい方を中心に、本人の意欲に合わせて段階的に上達したいお子様にも対応し、電子ピアノ環境でも基礎・読譜・表現を段階的に伸ばします。",
        ...
        areaGuide: "三好でレッスンを続ける鍵は、短時間練習でも達成感を積み上げる運用運用を行うことです。静かな住環境を活かし、短時間でも集中できるレッスン設計がしやすいという生活条件を前提に、学校・塾・仕事・家事と衝突しにくい曜日と時間帯を体験時に設計します。開始後は毎回の練習ポイントを短く共有し、次回までに何を行うかを明確にするため、忙しい週でも上達実感を得やすくなります。",
        lessonFlow: defaultLessonFlow,
    ...
    // ========================================
    {
        ...
        uniqueContent: "門前仲町でピアノ教室を検討する方には、江東区公開統計（2026年2月）で門前仲町の人口は2,479人、15〜64歳比率は79.0％という地域データがあります。門前仲町駅周辺は就業層比率が高く、平日夜に自宅で完結する需要が強いため、通室型では送迎や移動の負担が継続の壁になりやすい傾向があります。出張ピアノレッスンなら講師がご自宅に伺うため、移動時間を使わずにレッスンを開始できます。短期成果より継続を重視して基礎を積みたいご家庭を中心に、通室なしで仕事後に趣味を継続したい方にも対応し、電子ピアノ環境でも基礎・読譜・表現を段階的に伸ばします。",
        ...
        areaGuide: "門前仲町でレッスンを続ける鍵は、長期目標を見据えた段階設計運用を行うことです。歴史ある街区で長く住む世帯も多く、継続型の学習計画が受け入れられやすいという生活条件を前提に、学校・塾・仕事・家事と衝突しにくい曜日と時間帯を体験時に設計します。開始後は毎回の練習ポイントを短く共有し、次回までに何を行うかを明確にするため、忙しい週でも上達実感を得やすくなります。",
        lessonFlow: defaultLessonFlow,
    ...
    },
    {
        ...
        uniqueContent: "木場でピアノ教室を検討する方には、江東区公開統計（2026年2月）で木場の人口は11,390人、0〜14歳比率は12.0％という地域データがあります。木場公園周辺はファミリー居住が多く、平日夕方の送迎圧縮ニーズが高いため、通室型では送迎や移動の負担が継続の壁になりやすい傾向があります。出張ピアノレッスンなら講師がご自宅に伺うため、移動時間を使わずにレッスンを開始できます。移動負担を減らしつつ基礎を丁寧に学ばせたいご家庭を中心に、好きな曲を入口にモチベーションを維持したいお子様にも対応し、電子ピアノ環境でも基礎・読譜・表現を段階的に伸ばします。",
        ...
        areaGuide: "木場でレッスンを続ける鍵は、モチベーションを落とさない曲選定と基礎配分運用を行うことです。東西線沿線で移動はしやすい一方、帰宅後の可処分時間を守る設計が重要という生活条件を前提に、学校・塾・仕事・家事と衝突しにくい曜日と時間帯を体験時に設計します。開始後は毎回の練習ポイントを短く共有し、次回までに何を行うかを明確にするため、忙しい週でも上達実感を得やすくなります。",
        lessonFlow: defaultLessonFlow,
    ...
    },
    {
        ...
        uniqueContent: "越中島でピアノ教室を検討する方には、江東区公開統計（2026年2月）で越中島の人口は6,634人、65歳以上比率は22.7％という地域データがあります。越中島駅周辺は学生・社会人・シニアが混在し、時間帯別ニーズの差が大きいため、通室型では送迎や移動の負担が継続の壁になりやすい傾向があります。出張ピアノレッスンなら講師がご自宅に伺うため、移動時間を使わずにレッスンを開始できます。学校後の移動を最小化して継続したいご家庭を中心に、外出負担を抑えて音楽を再開したい方にも対応し、電子ピアノ環境でも基礎・読譜・表現を段階的に伸ばします。",
        ...
        areaGuide: "越中島でレッスンを続ける鍵は、世代差に合わせた時間帯と練習量の最適化運用を行うことです。駅近でも生活導線が分散しやすく、訪問型で移動を固定化しない設計が有効という生活条件を前提に、学校・塾・仕事・家事と衝突しにくい曜日と時間帯を体験時に設計します。開始後は毎回の練習ポイントを短く共有し、次回までに何を行うかを明確にするため、忙しい週でも上達実感を得やすくなります。",
        lessonFlow: defaultLessonFlow,
    ...
    // ========================================
    {
        ...
        uniqueContent: "人形町でピアノ教室を検討する方には、中央区の町丁別集計（2023年1月）で日本橋人形町の人口は5,366人という地域データがあります。人形町駅周辺は就業層と居住層が混在し、夜間・休日レッスン需要が高いため、通室型では送迎や移動の負担が継続の壁になりやすい傾向があります。出張ピアノレッスンなら講師がご自宅に伺うため、移動時間を使わずにレッスンを開始できます。仕事後に移動せず質の高い趣味時間を確保したい方を中心に、限られた平日時間で子どもの習い事を継続したいご家庭にも対応し、電子ピアノ環境でも基礎・読譜・表現を段階的に伸ばします。",
        ...
        areaGuide: "人形町でレッスンを続ける鍵は、仕事終わりの短時間でも成果を出す進行運用を行うことです。都心居住では移動時間そのものが機会損失になりやすく、訪問型の効果が出やすいという生活条件を前提に、学校・塾・仕事・家事と衝突しにくい曜日と時間帯を体験時に設計します。開始後は毎回の練習ポイントを短く共有し、次回までに何を行うかを明確にするため、忙しい週でも上達実感を得やすくなります。",
        lessonFlow: defaultLessonFlow,
    ...
    },
    {
        ...
        uniqueContent: "水天宮前でピアノ教室を検討する方には、中央区の町丁別集計（2023年1月）で日本橋蛎殻町・箱崎町の合算人口は9,178人という地域データがあります。水天宮前駅周辺はオフィス就業者が多く、平日夜の移動削減ニーズが強いため、通室型では送迎や移動の負担が継続の壁になりやすい傾向があります。出張ピアノレッスンなら講師がご自宅に伺うため、移動時間を使わずにレッスンを開始できます。移動を減らして限られた時間で趣味を継続したい方を中心に、親の移動負担を抑えて子どもの習い事を続けたいご家庭にも対応し、電子ピアノ環境でも基礎・読譜・表現を段階的に伸ばします。",
        ...
        areaGuide: "水天宮前でレッスンを続ける鍵は、移動をなくし可処分時間を練習に充てる設計運用を行うことです。幹線道路沿いの移動混雑を避けられる訪問型レッスンが時間効率を高めるという生活条件を前提に、学校・塾・仕事・家事と衝突しにくい曜日と時間帯を体験時に設計します。開始後は毎回の練習ポイントを短く共有し、次回までに何を行うかを明確にするため、忙しい週でも上達実感を得やすくなります。",
        lessonFlow: defaultLessonFlow,
    ...
    },
    {
        ...
        uniqueContent: "浜町でピアノ教室を検討する方には、中央区の町丁別集計（2023年1月）で日本橋浜町の人口は12,187人という地域データがあります。浜町公園周辺は居住と就業が近接し、移動時間の最適化が学習継続率に直結するため、通室型では送迎や移動の負担が継続の壁になりやすい傾向があります。出張ピアノレッスンなら講師がご自宅に伺うため、移動時間を使わずにレッスンを開始できます。生活リズムを崩さず上質なレッスン時間を持ちたい方を中心に、子どもと大人が同じ講師で長く続けたいご家庭にも対応し、電子ピアノ環境でも基礎・読譜・表現を段階的に伸ばします。",
        ...
        areaGuide: "浜町でレッスンを続ける鍵は、生活導線を崩さない上質な継続設計運用を行うことです。静かな住環境を活かし、夜間でも落ち着いて練習しやすいという生活条件を前提に、学校・塾・仕事・家事と衝突しにくい曜日と時間帯を体験時に設計します。開始後は毎回の練習ポイントを短く共有し、次回までに何を行うかを明確にするため、忙しい週でも上達実感を得やすくなります。",
        lessonFlow: defaultLessonFlow,
    ...
    // ========================================
    {
        ...
        uniqueContent: "森下でピアノ教室を検討する方には、江東区公開統計（2026年2月）で森下の人口は11,156人、65歳以上比率は19.6％という地域データがあります。森下駅周辺は子育て世帯と単身就業層が混在し、夕方以降の需要が高いため、通室型では送迎や移動の負担が継続の壁になりやすい傾向があります。出張ピアノレッスンなら講師がご自宅に伺うため、移動時間を使わずにレッスンを開始できます。お迎え後の短時間で効率よく習い事を進めたいご家庭を中心に、仕事と家庭の合間に無理なく再開したい大人の方にも対応し、電子ピアノ環境でも基礎・読譜・表現を段階的に伸ばします。",
        ...
        areaGuide: "森下でレッスンを続ける鍵は、お迎え後の時間を無駄にしない枠設計運用を行うことです。都営線沿線で帰宅時間帯が集中しやすく、送迎不要の形式が継続率を押し上げるという生活条件を前提に、学校・塾・仕事・家事と衝突しにくい曜日と時間帯を体験時に設計します。開始後は毎回の練習ポイントを短く共有し、次回までに何を行うかを明確にするため、忙しい週でも上達実感を得やすくなります。",
        lessonFlow: defaultLessonFlow,
    ...
    },
    {
        ...
        uniqueContent: "住吉でピアノ教室を検討する方には、江東区公開統計（2026年2月）で住吉の人口は5,165人、65歳以上比率は21.9％という地域データがあります。住吉駅・猿江エリアは住宅比率が高く、家庭内で完結する習い事需要が安定しているため、通室型では送迎や移動の負担が継続の壁になりやすい傾向があります。出張ピアノレッスンなら講師がご自宅に伺うため、移動時間を使わずにレッスンを開始できます。移動時間を減らして家庭時間を確保したいご家庭を中心に、外出負担を抑えながらピアノを再開したい方にも対応し、電子ピアノ環境でも基礎・読譜・表現を段階的に伸ばします。",
        ...
        areaGuide: "住吉でレッスンを続ける鍵は、家庭優先でも継続しやすい柔軟運用運用を行うことです。半蔵門線・新宿線利用で帰宅時間が読みづらく、訪問型の柔軟さが有効という生活条件を前提に、学校・塾・仕事・家事と衝突しにくい曜日と時間帯を体験時に設計します。開始後は毎回の練習ポイントを短く共有し、次回までに何を行うかを明確にするため、忙しい週でも上達実感を得やすくなります。",
        lessonFlow: defaultLessonFlow,
    ...
    },
    {
        ...
        uniqueContent: "菊川でピアノ教室を検討する方には、墨田区公開統計（2026年1月）で菊川一〜三丁目の人口は8,514人、15〜64歳比率は75.3％という地域データがあります。菊川駅周辺は就業層比率が高く、平日夜・短時間レッスン需要が目立つため、通室型では送迎や移動の負担が継続の壁になりやすい傾向があります。出張ピアノレッスンなら講師がご自宅に伺うため、移動時間を使わずにレッスンを開始できます。短時間で成果を出しながら継続したい学業・就業層を中心に、通室せず平日夕方に子どものレッスンを回したいご家庭にも対応し、電子ピアノ環境でも基礎・読譜・表現を段階的に伸ばします。",
        ...
        areaGuide: "菊川でレッスンを続ける鍵は、短時間高密度で上達を可視化する設計運用を行うことです。都心近接で移動先が多いため、訪問型で移動を固定しない設計が継続に有利という生活条件を前提に、学校・塾・仕事・家事と衝突しにくい曜日と時間帯を体験時に設計します。開始後は毎回の練習ポイントを短く共有し、次回までに何を行うかを明確にするため、忙しい週でも上達実感を得やすくなります。",
        lessonFlow: defaultLessonFlow,
